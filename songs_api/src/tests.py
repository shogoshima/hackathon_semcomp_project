...
keywords = "church, calm, peace, not loud"
response = co_chat(model='command', prompt=f'Based on these keyword : {keywords}, what genres of music would you recommend for a event? Please do not send any additional text besides the gender on a list on the following format: \nRock;Indie;\n', historic=[{}], co=co_client)
